            ...
            <div className="mt-16 w-full h-screen flex justify-center items-center absolute">
                    ...
                    <div className={`group`}>
                        <div className={`mt-52 absolute flex flex-col
                            ...
                            <h1 className={`text-center text-white text-2xl font-semibold`}>Instituto Ambiental Social<br></br>(ISA)</h1>
                            <div className={`flex justify-center items-center mt-4 group-hover:opacity-100`}><AcompanharButton></AcompanharButton></div>
                        </div>
                    ...
                    <div className={`group`}>
                        <div className={`mt-96 absolute flex flex-col ml-[5.5rem]
                                        group-hover:z-20 opacity-0 group-hover:opacity-100 transition-opacity `}>
                            <h1 className={`text-center text-white text-2xl font-semibold`}>SOS Mata Atlantica</h1>
                            <div className={`flex justify-center items-center mt-4 group-hover:opacity-100`}><AcompanharButton></AcompanharButton></div>
                        </div>
